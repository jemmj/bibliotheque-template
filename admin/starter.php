        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <a href="#" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="starter.php?page=bibliothequelist" class="nav-link">
           ...
           <li class="nav-item">
                <a href="?page=userslist" class="nav-link">
...
/*if($page=="livre"){
  include"../livrelist.php";
}
else if($page=="biblio") {
include"../biblio/bibliothequelist.php";
            }
